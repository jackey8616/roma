# 23. Codex is driven over app-server, and roma keeps its home

Date: 2026-08-04

## Status

Proposed — ADR-0022 decides that a second Runtime exists and how it is chosen;
...
1. A real-Workspace capture of `CARD_CLICKED` arriving over Pub/Sub — the
   selection's only path (ADR-0022), and the Overflow button's overdue proof.
